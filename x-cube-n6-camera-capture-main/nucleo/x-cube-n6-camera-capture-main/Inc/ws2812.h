...
/** Timer period from the validated hardware configuration. */
#define WS2812_PERIOD               500U

/** PWM values from the validated hardware configuration. */
#define WS2812_PWM_ONE              80U
